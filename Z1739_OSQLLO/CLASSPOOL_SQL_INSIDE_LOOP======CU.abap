...
*"* public components of class CLASSPOOL_SQL_INSIDE_LOOP
...
public section.
  ...
  interfaces IF_IFPOOL_SQL_INSIDE_LOOP .

  events EVENT_SQL_INSIDE_LOOP_KO2
    exporting
      value(I_MESSAGE) type STRING optional .

  methods ON_EVENT_SQL_INSIDE_LOOP_KO2
    for event EVENT_SQL_INSIDE_LOOP_KO2 of CLASSPOOL_SQL_INSIDE_LOOP
    importing I_MESSAGE .
    
  methods SEND_EVENT_SQL_INSIDE_LOOP_KO2
