...
FUNCTION-POOL FPOOL_WHERE_NULL .

BEGIN OF FUNCTION PARAMETERS FCT_WHERE_NULL_KO1.
EXPORTING VALUE(SY-SUBRC) TYPE I .
END OF FUNCTION PARAMETERS.
FUNCTION FCT_WHERE_NULL_KO1.
*"----------------------------------------------------------
*" Local interface:
*"  EXPORTING
*"     VALUE(SY-SUBRC)
...
BEGIN OF FUNCTION PARAMETERS FCT_WHERE_NULL_KO2.
EXPORTING SY-SUBRC .
END OF FUNCTION PARAMETERS.
FUNCTION FCT_WHERE_NULL_KO2.
*"----------------------------------------------------------
*" Local interface:
*" EXPORTING
*" SY-SUBRC
...
BEGIN OF FUNCTION PARAMETERS FCT_WHERE_NULL_KO3.
EXPORTING SY-SUBRC .
END OF FUNCTION PARAMETERS.
FUNCTION FCT_WHERE_NULL_KO3.
*"----------------------------------------------------------
*" Local interface:
*" EXPORTING
*" SY-SUBRC
...
BEGIN OF FUNCTION PARAMETERS FCT_WHERE_NULL_KO4.
EXPORTING SY-SUBRC .
END OF FUNCTION PARAMETERS.
FUNCTION FCT_WHERE_NULL_KO4.
*"----------------------------------------------------------
*" Local interface:
*" EXPORTING
*" SY-SUBRC
