...
*"* public components of class BADICLASSPOOL_BYPASSINGBUFFER
...
public section.
  ...
  interfaces IF_BADI_IFPOOL_BYPASSINGBUFFER .


  events BADI_EVENT_BYPASSINGBUFFER_KO2
    exporting
      value(I_MESSAGE) type STRING optional .

  methods ON_BADI_EVENT_BYPASSINGBUFFER_KO2
    for event BADI_EVENT_BYPASSINGBUFFER_KO2 of BADICLASSPOOL_BYPASSINGBUFFER
    importing I_MESSAGE .

  methods SEND_BADI_EVENT_BYPASSINGBUFFER_KO2
