...
*"* public components of class CLASSPOOL_WHERE_NULL
...
public section.
  ...
  interfaces IF_IFPOOL_WHERE_NULL .

  events EVENT_WHERE_NULL_KO2
    exporting
      value(I_MESSAGE) type STRING optional .
      
  events EVENT_WHERE_NULL_KO3
    exporting
      value(I_MESSAGE) type STRING optional .
      
  methods ON_EVENT_WHERE_NULL_KO2
    for event EVENT_WHERE_NULL_KO2 of CLASSPOOL_WHERE_NULL
    importing I_MESSAGE .
    
  methods ON_EVENT_WHERE_NULL_KO3
    for event EVENT_WHERE_NULL_KO3 of CLASSPOOL_WHERE_NULL
    importing I_MESSAGE .

  methods SEND_EVENT_WHERE_NULL_KO2
    importing I_MESSAGE type STRING optional .
    
  methods SEND_EVENT_WHERE_NULL_KO3
    importing I_MESSAGE type STRING optional .
