...
*"* public components of class BADICLASSPOOL_WITHOUT_WHERE
...
public section.
  ...
  interfaces IF_BADI_IFPOOL_WITHOUT_WHERE .


  events BADI_EVENT_WITHOUT_WHERE_KO2
    exporting
      value(I_MESSAGE) type STRING optional .

  methods ON_BADI_EVENT_WITHOUT_WHERE_KO2
    for event BADI_EVENT_WITHOUT_WHERE_KO2 of BADICLASSPOOL_WITHOUT_WHERE
    importing I_MESSAGE .

  methods SEND_BADI_EVENT_WITHOUT_WHERE_KO2
